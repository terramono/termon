                ...
                {isFileWriteTool &&
                    ...
                    Date.now() - toolData.runts < BackupRetentionDays * 24 * 60 * 60 * 1000 && (
                        <button
                            ...
                            className="flex-shrink-0 px-1.5 py-0.5 border border-border hover:border-border hover:bg-hover rounded cursor-pointer transition-colors flex items-center gap-1 text-secondary"
